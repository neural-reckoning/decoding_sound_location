...
if int(samplerate)!=97656:
    raise ValueError('Samplerate for Tollin data should be 97656.25Hz')

basename = 'joris_tollin_cat'
animal_name = 'Cat'
extraname = {}
space = TollinCatHRTFSpatial(adaptive_windowing=(512, 16, 256))
