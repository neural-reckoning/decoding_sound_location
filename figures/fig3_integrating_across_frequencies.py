...
formatting = {
    ...
    'Inequality pattern match':{'color':'k', 'ls':':', 'lw':lw},
    'Inequality pattern match 10k':{'color':'k', 'ls':'--', 'lw':lw},
    'Inequality pattern match 50k':{'color':'k', 'ls':'-', 'lw':lw},
    }
...
#        (MakeEstimator(PatternMatch, normalise_banded=40), 'Pattern match banded'),
        #(MakeEstimator(InequalityPatternMatch, 1000), 'Inequality pattern match'),
        #(MakeEstimator(InequalityPatternMatch, 10000), 'Inequality pattern match 10k'),
        #(MakeEstimator(InequalityPatternMatch, 50000), 'Inequality pattern match 50k'),
        )
